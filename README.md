...
<!--
    ...
    https://github.com/Heapy/awesome-kotlin/blob/main/.github/contributing.md
    for instructions.
...
* [allangomes/kotlinwind.css](https://github.com/allangomes/kotlinwind.css) - Kotlin DSL for CSS based on Tailwind.
...
* [mongodb/mongo-java-driver](https://github.com/mongodb/mongo-java-driver) - The official MongoDB Kotlin Driver allows developers to build server-side Kotlin applications with MongoDB.
...
* [darkredz/Zeko-SQL-Builder](https://github.com/darkredz/Zeko-SQL-Builder) 
...
* [Mr-Mappie/mappie](https://github.com/Mr-Mappie/mappie) - Kotlin compiler plugin generating type-safe and performant object mapping code.
...
* [fleeksoft/ksoup](https://github.com/fleeksoft/ksoup) - Kotlin Multiplatform library for working with HTML and XML. It's a port of the renowned Java library Jsoup.
...
* [FirstArtaxer/karbitrage](https://github.com/FirstArtaxer/karbitrage) - Kotlin-based project designed to extract cryptocurrency prices from various exchanges using the Ktor framework.
...
* [0xe1f/ararat](https://github.com/0xe1f/ararat) 

### <a name="android-projects"></a>Projects <sup>[Back ⇈](#android-projects-subcategory)</sup>
* [BanDev/Buddha-Quotes](https://github.com/BanDev/Buddha-Quotes) - A collaborative project to create a Free and Open Source Buddha Quotes app.
...
* [massivedisaster/AFM](https://github.com/massivedisaster/AFM) - A library to help android developers work easily with activities and fragments with Kotlin
...
* [halilozel1903/LearnKotlinProgramming](https://github.com/halilozel1903/LearnKotlinProgramming) - Let's Learn Kotlin Programming ❤️
...
* [matteocrippa/karamba](https://github.com/matteocrippa/karamba) - A Swiss army knife of useful extensions for Kotlin
...
* [Kotlin/kdoctor](https://github.com/Kotlin/kdoctor) - CLI tool that helps to set up the environment for Kotlin Multiplatform Mobile app development.
* [jzbrooks/vgo](https://github.com/jzbrooks/vgo) - vgo is a tool for optimizing and converting between vector artwork representations.

### <a name="android-tests"></a>Tests <sup>[Back ⇈](#android-tests-subcategory)</sup>
* [KakaoCup/Kakao](https://github.com/KakaoCup/Kakao) - Nice and simple DSL for Espresso in Kotlin
* [KakaoCup/Compose](https://github.com/KakaoCup/Compose) - Nice and simple DSL for Espresso Compose UI testing in Kotlin
...
* [Ayfri/PIXI-Kotlin](https://github.com/Ayfri/PIXI-Kotlin) - Typings for the graphics library PixiJs
...
* [trueangle/kotlin-native-aws-lambda-runtime](https://github.com/trueangle/kotlin-native-aws-lambda-runtime) - A runtime for executing AWS Lambda functions written in Kotlin/Native, designed to reduce cold start issues common with the JVM platform.

### <a name="kotlin-native-frameworks"></a>Frameworks <sup>[Back ⇈](#kotlin-native-frameworks-subcategory)</sup>
* [KwangIO/kwang](https://github.com/KwangIO/kwang) 
* [msink/kotlin-libui](https://github.com/msink/kotlin-libui) 


## <a name="kotlin-webassembly"></a>Kotlin WebAssembly <sup>[Back ⇈](#kotlin-webassembly-category)</sup>
### <a name="kotlin-webassembly-official-links"></a>Official Links <sup>[Back ⇈](#kotlin-webassembly-official-links-subcategory)</sup>
* [Kotlin/Wasm Overview](https://kotl.in/wasm) - Learn everything about Kotlin WebAssembly platform

### <a name="kotlin-webassembly-examples"></a>Examples <sup>[Back ⇈](#kotlin-webassembly-examples-subcategory)</sup>
* [Kotlin/Wasm Examples](https://github.com/Kotlin/kotlin-wasm-examples) - Explore a variety of Kotlin/Wasm example projects, showcasing applications like Compose Multiplatform, browser DOM API, Node.js, and WASI integration.
